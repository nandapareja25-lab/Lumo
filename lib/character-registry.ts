...
export const CHARACTER_REGISTRY: CharacterRecord[] = [
  // ---- Personajes con Character Card aprobada (consolidados desde characters/*.md) ----
  {
    id: "lumo",
    nombre: "Lumo",
    descripcionCanonica: "Luciérnaga mágica, mascota y guía narrador de la app.",
    edadAparente: "n/a (personaje mascota)",
    rasgosVisuales: ["abdomen bioluminiscente dorado", "ojos grandes con catchlight doble", "alas translúcidas iridiscentes"],
    vestuario: "n/a",
    paleta: { primario: "#1A2A1A", secundario: "#2A3A10", acento: "#FFD740" },
