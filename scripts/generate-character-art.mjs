// Generador de producción — usa el prompt ensamblado en MASTER-PROMPT-SYSTEM.md.
// Nomenclatura de salida según CLAUDE.md §8.2: [personaje-slug]_[tipo]_[escena-slug]_[tamaño].webp
...
async function main() {
  console.log("Generando lumo_circle_default...");
  ...
  const out2x = path.join(dir, "lumo_circle_default_400x400.webp");
  const out1x = path.join(dir, "lumo_circle_default_200x200.webp");
